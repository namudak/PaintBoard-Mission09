 ...
 *
 */
public class Mission09PaintBoard extends View {
	 ...
	 * @param c
	 */
	public Mission09PaintBoard(Context context) {
		super(context);
		...
		Log.i("Mission09PaintBoard", "initialized.");
	...
	public void saveUndo()
	{
		...
		Log.i("Mission09PaintBoard", "saveUndo() called.");
	}
	...
	public void undo()
	{
		...
		try {
			...
			Log.e("Mission09PaintBoard", "Exception : " + ex.getMessage());
		}
		...
		Log.i("Mission09PaintBoard", "undo() called.");
	}	
	 ...
	 * @param checkedId
	 */
	public void setCapStyle(int checkedId) {
		switch(checkedId) {
			case R.id.buttStyleBtn:
				mPaint.setStrokeCap(Cap.BUTT);
				break;
			case R.id.roundStyleBtn:
				mPaint.setStrokeCap(Cap.ROUND);
				break;
			case R.id.squareStyleBtn:
